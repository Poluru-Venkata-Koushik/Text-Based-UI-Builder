...
view_p1=tk.Button(left_frame,text="Download Code",font=('Bahnschrift',10),bg="Green",fg='white',border=0,width=20)
...
view_p2=tk.Button(left_frame,text="Download Code",font=('Bahnschrift',10),bg="Green",fg='white',border=0,width=20)
...
view_p4=tk.Button(left_frame,text="Download Code",font=('Bahnschrift',10),bg="Green",fg='white',border=0,width=20)
...
view_p5=tk.Button(left_frame,text="Download Code",font=('Bahnschrift',10),bg="Green",fg='white',border=0,width=20)
...
view_p6=tk.Button(left_frame,text="Download Code",font=('Bahnschrift',10),bg="Green",fg='white',border=0,width=20)
